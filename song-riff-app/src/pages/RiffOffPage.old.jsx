 ...
 */
const LyricColumn = ({ songTitle, artist, lyrics, songId, onLyricClick, selectedLyric, spotify }) => (
  <>
...
const RiffOffPage = ({ songsWithLyrics, setSongsWithLyrics }) => {
  ...
  return (
    ...
    >
      {/* Fixed Progress Trail - outside scrollable content */}
...
{/* Action Bar with Similarity and Next Round */}
